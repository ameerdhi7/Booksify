        ...
        <div class="col-sm-6">
            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5">
                    ...
                    <!-- Form -->
                    <form action="/dashboard/categories/{{$category->id}}" method="post" class="text-center">
                        @csrf
                         @method('patch')
                        <div class="row align-items-center justify-content-between mt-4">
                            <div class="col">
                                ...
                                <input type="text" name="type" type="text" id="type" class="form-control" value="{{old('type',"$category->type")}}">
